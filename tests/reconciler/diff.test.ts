...
describe("diff", () => {
  ...
  it("handles nested object differences", () => {
    ...
    const actual: Map<string, Record<string, unknown>> = new Map([["a", { config: { timeout: 10000, retries: 3 } }]]);
...
describe("diff with stripServerFields", () => {
  it("yields NOOP when only server fields differ", () => {
    ...
    const actual = { id: 42, name: "A", value: 1, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2025-01-02T00:00:00Z" };
