...
TBD — This capability provides exhaustive YAML example files for all Kener resource kinds, serving as canonical reference for users creating their own state manifests.
