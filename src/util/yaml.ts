...
export function loadYamlFromFile<T = unknown>(content: string, filePath: string): YamlLoadResult<T> {
  try {
...
export function loadAllYamlFromFile<T = unknown>(content: string, filePath: string): YamlLoadResult<T>[] {
  try {
