...
import { configFilePath, configDir, loadConfigRaw } from "@/config/loader";
...
const listSubcommand = defineCommand({
  ...
  async run() {
    try {
      ...
      const contexts = raw.config["contexts"] as Array<{ name: string; instance: string; apiKey: string }> | undefined;
